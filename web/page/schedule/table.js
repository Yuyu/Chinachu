				...
				ui : new sakura.ui.Button({
					...
					onClick: function () {
						...
						var form = flagrate.createForm({
							fields: [
								...
								},
								{
									...
									label: 'NOTIFY CATEGORY'.__(),
									text: 'WUI NOTIFY CATEGORY'.__(),
									input: {
										type : 'checkboxes',
						...
						flagrate.createModal({
							title: 'PROGRAM TABLE SETTINGS'.__(),
						...
						if (Prototype.Browser.MobileSafari) {
							...
							var contextMenuItems = [
								...
								'------------------------------------------',
								{
									label   : 'COPY SCOT'.__() + "...",
									onSelect: function (e) {
										window.prompt('COPY FOLLOWING'.__(), chinachu.util.scotify(a.program));
									}
								},
								{
									label   : 'COPY ID'.__() + "...",
									onSelect: function () {
										window.prompt('COPY FOLLOWING'.__(), a.program.id);
									}
								},
								{
									label   : 'COPY TITLE'.__() + "...",
									onSelect: function () {
										window.prompt('COPY FOLLOWING'.__(), a.program.title);
									}
								},
								{
									label   : 'COPY DESCRIPTION'.__() + "...",
									onSelect: function () {
										window.prompt('COPY FOLLOWING'.__(), a.program.detail);
									}
								},
								'------------------------------------------',
								{
